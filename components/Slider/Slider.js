...
const Slider = ({ blok }) => {
  function splitIntoBadges(elementsList, bgColor) {
    ...
    return <div className={styles["badges-list"]}>{badgesList}</div>;
  }
            ...
            {blok.cards.map((card, i) => {
              return (
                <SwiperSlide className={styles["card-container"]} key={i}>
                  <div
                    className={styles["custom-slide-container"]}
                  ...
                  >
                    <div className={styles["card"]}>
                      ...
                      <a
                        href={card.blogLink.cached_url}
                        className={styles["btn"]}
                        style={applyButtonStyle(card.themeColor)}
                      >
                        View Project
                      </a>
                    </div>
